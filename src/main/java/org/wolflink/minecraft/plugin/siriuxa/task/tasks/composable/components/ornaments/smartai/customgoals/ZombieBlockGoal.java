package org.wolflink.minecraft.plugin.siriuxa.task.tasks.composable.components.ornaments.smartai.customgoals;
...
public class ZombieBlockGoal extends Goal {
    ...
    public boolean canUse() {
        return zombie.getTarget() != null && zombie.getTarget().position().y - zombie.position().y >= 2;
    }
