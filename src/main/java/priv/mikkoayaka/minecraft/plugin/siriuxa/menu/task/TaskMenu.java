package priv.mikkoayaka.minecraft.plugin.siriuxa.menu.task;

import org.wolflink.common.ioc.IOC;
import priv.mikkoayaka.minecraft.plugin.siriuxa.api.view.BorderIcon;
...
import priv.mikkoayaka.minecraft.plugin.siriuxa.menu.MenuService;
import priv.mikkoayaka.minecraft.plugin.siriuxa.menu.difficulty.ExplorationDifficultyMenu;
import priv.mikkoayaka.minecraft.plugin.siriuxa.menu.task.icon.CreateTask;
import priv.mikkoayaka.minecraft.plugin.siriuxa.menu.task.icon.SelectDifficulty;
